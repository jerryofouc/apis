...
public class AuthorizationServerFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
        ...
        */
        ...
        if (accessToken != null) {
            VerifyTokenResponse tokenResponse = getVerifyTokenResponse(accessToken,requestURL);
    ...
    protected VerifyTokenResponse getVerifyTokenResponse(String accessToken, String requestURL) {
        ...
        if (verifyTokenResponse == null) {
            ClientResponse res = client.resource(String.format("%s?access_token=%s&accessURL=%s", authorizationServerUrl, accessToken,requestURL))
